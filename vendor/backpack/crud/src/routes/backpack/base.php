...
// Route::get('/', 'Backpack\CRUD\app\Http\Controllers\AdminController@redirect')->name('backpack');
// Route::get('home', 'Backpack\CRUD\app\Http\Controllers\AdminController@dashboard')->name('backpack.dashboard');
